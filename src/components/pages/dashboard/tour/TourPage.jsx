...
import { requestGetTour, requestAddTour, requestUpdateTour, requestDeleteTour, requestGetTourDetails } from '../../../../actions/tour';
    ...
    render() {
        ...
        const MainContent = () => {
            switch (this.state.views) {
                                ...
                                <div className="b-respos">
                                    ...
                                    <div className="row">
                                        {this.state.pageOfItems.map(data => (
                                            <CardResposComponent key={data.id} onDelete={this.onDelete} data={data} onEdit={this.onEdit} onDetail={this.onDetail} switchViews={this.switchViews} choice="TOUR"></CardResposComponent>
                                        ))}
                                    </div>
                ...
                case 'VIEW_FORM':
                    return (
                        <FormComponent onAdd={this.onAdd.bind(this)} switchViews={this.switchViews} edit={this.state.edit} dataEdit={this.state.dataEdit} onUpdate={this.onUpdate} choice="TOUR"></FormComponent>
                    )
                case 'VIEW_DETAIL':
                    return (
                ...
                <main className="b-dashboard-main">
                    <div className="b-dashboard">
                        ...
                        <div className="b-block-right">
                            <HeaderComponent title="Tour"></HeaderComponent>
                            {MainContent()}
...
export default connect(mapStateToProps, { requestGetTour, requestDeleteTour, requestAddTour, requestUpdateTour, requestGetTourDetails, requestExistToken, requestLogout })(TourPage);