...
import { requestGetTourImages, requestAddTourImages, requestDeleteTourImages, requestUpdateTourImage } from '../../../../actions/tour';
                    ...
                    <table className="b-table">
                        ...
                        <tbody>
                            {this.state.pageOfItems.map(data => (
                                <TableComponent key={data.id} data={data} onDelete={this.onDelete} onEdit={this.onEdit} is_authorities={is_authorities} choice="TOUR_IMAGES"></TableComponent>
                            ))}
                        </tbody>
                    </table>
                )
            ...
            switch (this.state.switch) {
                                        ...
                                        <div className="b-block">
                                            <div className="b-block-left">
                                                <h2 className="b-text-title">
                                                    <i className="fab fa-canadian-maple-leaf" /> Tour Images Dashboard
                                            </h2>
                                            </div>
                ...
                case "FORM":
                    return (
                        <section className="b-dashboard-table">
                            <div className="container-fluid">
                                <FormGroupComponent dataEdit={this.state.dataEdit} tour={this.props.tour} edit={this.state.edit} onSwitch={this.onSwitch} onAdd={this.onAdd} onUpdate={this.onUpdate} choice="TOUR_IMAGES"></FormGroupComponent>
                            </div>
                        </section>
                    )
                default:
        ...
        return (
            <div className="b-wrapper">
                ...
                <main className="b-dashboard-main">
                    <OptionComponent title="Tour Images Dashboard"></OptionComponent>
                    {mainContent()}
                </main>
...
export default connect(mapStateToProps, { requestGetTour, requestCheckStaff, requestGetTourImages, requestDeleteTourImages, requestAddTourImages, requestUpdateTourImage })(TourImages);