...
import { requestGetUser, requestDeleteUser, requestAddUsers, requestUpdateUsers } from '../../../../actions/user';
...
class UserPage extends Component {
    ...
    onDelete = (id) => {
        this.props.requestDeleteUser(id);
    }
    onForm = () => {
        this.setState({
            switch: "FORM",
    ...
    onAdd = (data) => {
        this.props.requestAddUsers(data);
        this.setState({
            switch: "LIST"
        })
    }
    ...
    onUpdate = (data) => {
        this.props.requestUpdateUsers(data);
        this.setState({
            switch: "LIST"
        })
    }
                    ...
                    <table className="b-table">
                        ...
                        <tbody>
                            {this.state.pageOfItems.map(data => (
                                <TableComponent key={data.id} data={data} onDelete={this.onDelete} onEdit={this.onEdit} is_authorities={is_authorities} choice="USER"></TableComponent>
                            ))}
                        </tbody>
                    </table>
                )
            ...
            switch (this.state.switch) {
                ...
                case "FORM":
                    return (
                        <section className="b-dashboard-table">
                            <div className="container-fluid">
                                <FormGroupComponent dataEdit={this.state.dataEdit} edit={this.state.edit} onSwitch={this.onSwitch} onAdd={this.onAdd} onUpdate={this.onUpdate} choice="USER"></FormGroupComponent>
                            </div>
                        </section>
                    )
                default:
...
export default connect(mapStateToProps, { requestCheckStaff, requestGetUser, requestDeleteUser, requestAddUsers, requestUpdateUsers, requestExistToken, requestLogout })(UserPage);