                    ...
                    <table className="b-table">
                        ...
                        <tbody>
                            {this.state.pageOfItems.map(data => (
                                <TableComponent key={data.id} data={data} onDelete={this.onDelete} onEdit={this.onEdit} is_authorities={is_authorities} choice="PLACE"></TableComponent>
                            ))}
                        </tbody>
                    </table>
                )
            ...
            switch (this.state.switch) {
                                        ...
                                        <div className="b-block">
                                            <div className="b-block-left">
                                                <h2 className="b-text-title">
                                                    <i className="fab fa-canadian-maple-leaf" /> Extended Pagination
                                            </h2>
                                            </div>
                ...
                case "FORM":
                    return (
                        <section className="b-dashboard-table">
                            <div className="container-fluid">
                                <FormGroupComponent dataEdit={this.state.dataEdit} edit={this.state.edit} onSwitch={this.onSwitch} onAdd={this.onAdd} onUpdate={this.onUpdate} choice="PLACE"></FormGroupComponent>
                            </div>
                        </section>
                    )
                default:
...
export default connect(mapStateToProps, { requestCheckStaff, requestGetPlace, requestDeletePlace, requestAddPlace, requestUpdatePlace, requestGetPlaceDetails, requestExistToken, requestLogout })(PlacePage);