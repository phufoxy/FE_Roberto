    ...
    render() {
        ...
        const MainContent = () => {
            switch (this.state.views) {
                                ...
                                <div className="b-respos">
                                    ...
                                    <div className="row">
                                        {this.state.pageOfItems.map(data => (
                                            <CardResposComponent key={data.id} onDelete={this.onDelete} data={data} onEdit={this.onEdit} onDetail={this.onDetail} switchViews={this.switchViews} choice="BLOG" ></CardResposComponent>
                                        ))}
                                    </div>
                ...
                case 'VIEW_FORM':
                    return (
                        <FormComponent onAdd={this.onAdd.bind(this)} switchViews={this.switchViews} edit={this.state.edit} dataEdit={this.state.dataEdit} onUpdate={this.onUpdate} choice="BLOG"></FormComponent>
                    )
                case 'VIEW_DETAIL':
                    return (
...
export default connect(mapStateToProps, {  requestGetBlog, requestAddBlog, requestDeleteBlog, requestUpdateBlog, requestExistToken, requestLogout })(BlogPage);